...
**Targeted Customer in Wave-2 and Projected Profit**
...
From this study we can draw the conclusion that the high margin of selling quickbooks provides us with the opportunity to target more high-potential customers with less efforts. Besides, lower bound predictive approach in both logistic and neural network is too conservative to achieve the highest profit.
